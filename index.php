<?php
	$today = date("Y/m");
	$month = isset($_GET['month'])?$_GET['month']:$today;
	$url = 'http://10.10.40.110:8080/trafficdataAPI/api/read.php?month='.$month;
	$ch = curl_init($url);
...
<body>
	...
	<?php foreach($response['data'] as $data){  ?>
			...
			<td><?php echo $data['date']; ?></td>
                	<td><a href="http://10.10.40.110:8080/trafficdataAPI/chart.php?ip=<?php echo $data['ip']; ?>&mon=<?php echo $month;?>" target="_blank"><?php echo $data['ip']; ?></a></td>
